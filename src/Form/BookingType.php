...
class BookingType extends ApplicationType
{
    ...
    {
        $builder
            ->add('startDate', TextType::class, $this->getConfiguration("Date d'arrivée", "La date à laquelle vous contez arriver"))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            ...
            'validation_groups' => new GroupSequence(['Default', 'front'])
        ]);
    }
}
